...
const returnNames = (arr_data) => {
  return arr_data.reduce(function(newArr, obj) {
...
const countNumberOfChildren = (arr) => {
  return arr.reduce(function (total, obj) {
    return total + (('children' in obj) ? obj.children.length : 0);
  }, 0);
};
...
const countPrimeNumbers = (arr) => {
  return arr.reduce((total, num) => total + isPrime(num), 0);
};
